...
std::string ArenaSpectatorNPC::GetClassIconById(uint8 id) {
    ...
    switch (id) {
        case CLASS_WARRIOR:
            sClass = "|TInterface\\icons\\inv_sword_27.png:17|t";
            break;
        case CLASS_PALADIN:
            sClass = "|TInterface\\icons\\inv_hammer_01.png:17|t";
            break;
        case CLASS_HUNTER:
            sClass = "|TInterface\\icons\\inv_weapon_bow_07.png:17|t";
            break;
        case CLASS_ROGUE:
            sClass = "|TInterface\\icons\\inv_throwingknife_04.png:17|t";
            break;
        case CLASS_PRIEST:
            sClass = "|TInterface\\icons\\inv_staff_30.png:17|t";
            break;
        case CLASS_DEATH_KNIGHT:
            sClass = "|TInterface\\icons\\spell_deathknight_classicon.png:17|t";
            break;
        case CLASS_SHAMAN:
            sClass = "|TInterface\\icons\\inv_jewelry_talisman_04.png:17|t";
            break;
        case CLASS_MAGE:
            sClass = "|TInterface\\icons\\inv_staff_13.png:17|t";
            break;
        case CLASS_WARLOCK:
            sClass = "|TInterface\\icons\\spell_nature_drowsy.png:17|t";
            break;
        case CLASS_DRUID:
            sClass = "|TInterface\\icons\\inv_misc_monsterclaw_04.png:17|";
            break;
    }
    return sClass;
}
