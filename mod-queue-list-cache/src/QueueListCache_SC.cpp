...
public:
    ...
    {
        static ChatCommandTable queueCommandTable = // .show bg / .show bg / .show arena / .show skirmish
        {
            { "bg", HandleQueueShowBgCommand, SEC_PLAYER, Console::Yes},
            { "arena", HandleQueueShowArenaRatedCommand, SEC_PLAYER, Console::Yes},
            { "skirmish", HandleQueueShowArenaNormalCommand, SEC_PLAYER, Console::Yes}
        };

        static ChatCommandTable commandTable =  // .show
        {
            { "show", queueCommandTable }
        };
