...
void DSPlayerScript::ResurrectPlayer(Player* player)
{
    ...
    if (sConfigMgr->GetBoolDefault("DungeonRespawn.RemoveAurasAndCooldownsOnResurrect", true))
    {
        // Remove auras e reinicializa cooldowns ao clickar em release (se a opção estiver ativada)
