...
enum GossipId
{
    ...
    ASSISTANT_GOSSIP_ENCHANTSCROLLS = 800,
    ASSISTANT_GOSSIP_PROFESSIONITEMS = 900,
};
...
enum VendorId
{
    ...
    ASSISTANT_VENDOR_ENCHANTSCROLLS  = 9000031,
	ASSISTANT_VENDOR_PROFESSIONITEMS = 9000050,
};
...
bool aEnableEnchantScrolls;
bool aEnableProfessionItems;
...
public:
    ...
    bool OnGossipSelect(Player* player, Creature* creature, uint32 sender, uint32 action)
    {
        ...
        else if (action == ASSISTANT_GOSSIP_ENCHANTSCROLLS + 1)
            {
            player->GetSession()->SendListInventory(creature->GetGUID(), ASSISTANT_VENDOR_ENCHANTSCROLLS);
            }
        else if (action == ASSISTANT_GOSSIP_ENCHANTSCROLLS + 3)
            {
            player->GetSession()->SendListInventory(creature->GetGUID(), ASSISTANT_VENDOR_ENCHANTSCROLLS + 2);
            }
        else if (action == ASSISTANT_GOSSIP_ENCHANTSCROLLS + 4)
            {
            player->GetSession()->SendListInventory(creature->GetGUID(), ASSISTANT_VENDOR_ENCHANTSCROLLS + 3);
            }
        else if (action == ASSISTANT_GOSSIP_ENCHANTSCROLLS + 5)
            {
            player->GetSession()->SendListInventory(creature->GetGUID(), ASSISTANT_VENDOR_ENCHANTSCROLLS + 4);
            }
        else if (action == ASSISTANT_GOSSIP_ENCHANTSCROLLS + 6)
            {
            player->GetSession()->SendListInventory(creature->GetGUID(), ASSISTANT_VENDOR_ENCHANTSCROLLS + 5);
            }
        else if (action == ASSISTANT_GOSSIP_ENCHANTSCROLLS + 7)
            {
            player->GetSession()->SendListInventory(creature->GetGUID(), ASSISTANT_VENDOR_ENCHANTSCROLLS + 6);
            }
        else if (action == ASSISTANT_GOSSIP_ENCHANTSCROLLS + 8)
            {
            player->GetSession()->SendListInventory(creature->GetGUID(), ASSISTANT_VENDOR_ENCHANTSCROLLS + 7);
            }
        else if (action == ASSISTANT_GOSSIP_ENCHANTSCROLLS + 9)
            {
            player->GetSession()->SendListInventory(creature->GetGUID(), ASSISTANT_VENDOR_ENCHANTSCROLLS + 8);
            }
        else if (action == ASSISTANT_GOSSIP_ENCHANTSCROLLS + 11)
            {
            player->GetSession()->SendListInventory(creature->GetGUID(), ASSISTANT_VENDOR_ENCHANTSCROLLS + 10);
            }
        else if (action == ASSISTANT_GOSSIP_ENCHANTSCROLLS + 12)
            {
            player->GetSession()->SendListInventory(creature->GetGUID(), ASSISTANT_VENDOR_ENCHANTSCROLLS + 11);
            }
        else if (action == ASSISTANT_GOSSIP_PROFESSIONITEMS)
            {
            ClearGossipMenuFor(player);
            AddGossipItemFor(player, GOSSIP_ICON_VENDOR, "I want ore", GOSSIP_SENDER_MAIN, ASSISTANT_GOSSIP_PROFESSIONITEMS + 1);
            AddGossipItemFor(player, GOSSIP_ICON_VENDOR, "I want gem", GOSSIP_SENDER_MAIN, ASSISTANT_GOSSIP_PROFESSIONITEMS + 2);
            AddGossipItemFor(player, GOSSIP_ICON_VENDOR, "I want element", GOSSIP_SENDER_MAIN, ASSISTANT_GOSSIP_PROFESSIONITEMS + 3);
            AddGossipItemFor(player, GOSSIP_ICON_VENDOR, "I want leather", GOSSIP_SENDER_MAIN, ASSISTANT_GOSSIP_PROFESSIONITEMS + 4);
            AddGossipItemFor(player, GOSSIP_ICON_VENDOR, "I want essence", GOSSIP_SENDER_MAIN, ASSISTANT_GOSSIP_PROFESSIONITEMS + 5);
            AddGossipItemFor(player, GOSSIP_ICON_VENDOR, "I want plant", GOSSIP_SENDER_MAIN, ASSISTANT_GOSSIP_PROFESSIONITEMS + 6);
            AddGossipItemFor(player, GOSSIP_ICON_VENDOR, "I want ink", GOSSIP_SENDER_MAIN, ASSISTANT_GOSSIP_PROFESSIONITEMS + 7);
            AddGossipItemFor(player, GOSSIP_ICON_VENDOR, "I want cloth", GOSSIP_SENDER_MAIN, ASSISTANT_GOSSIP_PROFESSIONITEMS + 8);
            AddGossipItemFor(player, GOSSIP_ICON_VENDOR, "I want meat", GOSSIP_SENDER_MAIN, ASSISTANT_GOSSIP_PROFESSIONITEMS + 9);
            AddGossipItemFor(player, GOSSIP_ICON_VENDOR, "I want fish", GOSSIP_SENDER_MAIN, ASSISTANT_GOSSIP_PROFESSIONITEMS + 10);
            AddGossipItemFor(player, GOSSIP_ICON_CHAT, "Previous Page", GOSSIP_SENDER_MAIN, 1);
            SendGossipMenuFor(player, ASSISTANT_GOSSIP_TEXT, creature->GetGUID());
            }
        else if (action == ASSISTANT_GOSSIP_PROFESSIONITEMS + 1)
            {
            player->GetSession()->SendListInventory(creature->GetGUID(), ASSISTANT_VENDOR_PROFESSIONITEMS);
            }
        else if (action == ASSISTANT_GOSSIP_PROFESSIONITEMS + 2)
            {
            player->GetSession()->SendListInventory(creature->GetGUID(), ASSISTANT_VENDOR_PROFESSIONITEMS + 1);
            }
        else if (action == ASSISTANT_GOSSIP_PROFESSIONITEMS + 3)
            {
            player->GetSession()->SendListInventory(creature->GetGUID(), ASSISTANT_VENDOR_PROFESSIONITEMS + 2);
            }
        else if (action == ASSISTANT_GOSSIP_PROFESSIONITEMS + 4)
            {
            player->GetSession()->SendListInventory(creature->GetGUID(), ASSISTANT_VENDOR_PROFESSIONITEMS + 3);
            }
        else if (action == ASSISTANT_GOSSIP_PROFESSIONITEMS + 5)
            {
            player->GetSession()->SendListInventory(creature->GetGUID(), ASSISTANT_VENDOR_PROFESSIONITEMS + 4);
            }
        else if (action == ASSISTANT_GOSSIP_PROFESSIONITEMS + 6)
            {
            player->GetSession()->SendListInventory(creature->GetGUID(), ASSISTANT_VENDOR_PROFESSIONITEMS + 5);
            }
        else if (action == ASSISTANT_GOSSIP_PROFESSIONITEMS + 7)
            {
            player->GetSession()->SendListInventory(creature->GetGUID(), ASSISTANT_VENDOR_PROFESSIONITEMS + 6);
            }
        else if (action == ASSISTANT_GOSSIP_PROFESSIONITEMS + 8)
            {
            player->GetSession()->SendListInventory(creature->GetGUID(), ASSISTANT_VENDOR_PROFESSIONITEMS + 7);
            }
        else if (action == ASSISTANT_GOSSIP_PROFESSIONITEMS + 9)
            {
            player->GetSession()->SendListInventory(creature->GetGUID(), ASSISTANT_VENDOR_PROFESSIONITEMS + 8);
            }
        else if (action == ASSISTANT_GOSSIP_PROFESSIONITEMS + 10)
            {
            player->GetSession()->SendListInventory(creature->GetGUID(), ASSISTANT_VENDOR_PROFESSIONITEMS + 9);
            }
...
public:
    ...
    void OnAfterConfigLoad(bool /*reload*/) override
    {
        ...
        aEnableEnchantScrolls = sConfigMgr->GetOption<bool>("Assistant.EnchantScrolls", 1);
        aEnableProfessionItems = sConfigMgr->GetOption<bool>("Assistant.ProfessionItems", 1);
