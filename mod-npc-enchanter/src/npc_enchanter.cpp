...
enum Enchants
{
	...
	ENCHANT_GLOVES_MIGHTYSPELL = 3246,
...
public:
    ...
    bool OnGossipSelect(Player* player, Creature* creature, uint32 /*sender*/, uint32 action)
    {
        ...
        case 1: // Enchant Main Hand Weapon
            if (player->HasSkill(SKILL_ENCHANTING) && player->GetSkillValue(SKILL_ENCHANTING) >= 480)
            {
        ...
        case 3: // Enchant Shield
            ...
            if (item->GetTemplate()->InventoryType == INVTYPE_SHIELD)
            {
                ...
                AddGossipItemFor(player, 1, "36 Block", GOSSIP_SENDER_MAIN, 123);
                AddGossipItemFor(player, 1, "18 Stamina", GOSSIP_SENDER_MAIN, 122);
                AddGossipItemFor(player, 1, "81 Block + 50% Less Disarm", GOSSIP_SENDER_MAIN, 121);
                AddGossipItemFor(player, GOSSIP_ICON_TALK, "Back", GOSSIP_SENDER_MAIN, 300);
            }
            else
            {
        ...
        case 6: // Enchant Cloak
            ...
            AddGossipItemFor(player, 1, "Increased Stealth and +10 Agility", GOSSIP_SENDER_MAIN, 148);
        ...
        case 9: //Enchant Gloves
			...
			AddGossipItemFor(player, 1, "28 Spell Power", GOSSIP_SENDER_MAIN, 225);
        ...
        case 10: //Enchant legs
		    ...
		    if (player->HasSkill(SKILL_LEATHERWORKING) && player->GetSkillValue(SKILL_LEATHERWORKING) >= 490)
            {
        ...
        case 199:
            Enchant(player, creature, player->GetItemByPos(INVENTORY_SLOT_BAG_0, EQUIPMENT_SLOT_HANDS), ENCHANT_GLOVES_PYRO_ROCKET);
            break;
        ...
        case 201:
            Enchant(player, creature, player->GetItemByPos(INVENTORY_SLOT_BAG_0, EQUIPMENT_SLOT_HANDS), ENCHANT_GLOVES_ARMOR_WEBBING);
            break;
