    ...
    void OnLogin(Player* player)
    {
        if (sGlobalChatMgr->GlobalChatEnabled)
        {
            if (sGlobalChatMgr->Announce)
            {
                ...
                ChatHandler(player->GetSession()).PSendSysMessage("O servidor utiliza o module |cff4CFF00GlobalChat|r. Digite |cff4CFF00.help global|r para descobrir como usa-lo.");
            }
